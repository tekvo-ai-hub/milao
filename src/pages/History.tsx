...
const History: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col bg-gradient-to-br from-background via-accent/20 to-background">
      {/* Minimal Navbar (copied from Index.tsx) */}
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold mb-1">Recording History</h1>
        <p className="text-gray-500 mb-6">Review your past speeches and track your improvement journey.</p>
        ...
        <div className="space-y-6 mb-8">
          {filtered.map((rec) => (
            <Card key={rec.id} className="rounded-2xl shadow-lg p-0 flex flex-col md:flex-row items-center md:items-stretch gap-0 md:gap-6">
              <CardContent className="flex-1 flex flex-col md:flex-row items-center md:items-center gap-4 py-6 px-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <h2 className="text-lg font-bold truncate">{rec.title}</h2>
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-semibold">{rec.overall}% Overall</span>
        ...
        {/* Pagination */}
        <div className="flex flex-col sm:flex-row items-center sm:justify-end gap-4 mt-4">
          <span className="text-gray-500 text-sm sm:order-2 sm:ml-4">Showing {filtered.length} of 47 recordings</span>
